...
describe "Projects" do
  ...
  describe "new and create" do
    ...
    it "should present the form and save the data" do
      expect(all("form#new_project").size).to eq(1)
  ...
  describe "edit" do
    ...
    it 'edit tab should be present' do
      expect(page).to have_selector("a[href='#{edit_project_path(project)}']")
    end
  end
  ...
  describe "budget" do
    ...
    it 'budget tab should be present' do
      expect(page).to have_selector("a[href='#{budget_project_path(project)}']")
    end
  end
   ...
   context 'when is my project' do
      ...
      describe '#updates' do
        it 'should be able to click on updates tab' do
           ...
           expect(current_path).to eq(project_updates_path(project))
        end
      end
      ...
      describe '#contributions' do
        it 'should be able to click on contributions tab' do
          within 'nav.tabs' do
            ...
            expect(current_path).to eq(project_contributions_path(project))
          end
        end
      end
      ...
      describe '#comments' do
        it 'should be able to click on comments tab' do
           ...
           expect(current_path).to eq(comments_project_path(project))
        end
      end
      ...
      describe '#faqs' do
        it 'should be able to click on faqs tab' do
           ...
           expect(current_path).to eq(project_faqs_path(project))
        end
      end
      ...
      describe '#terms' do
        it 'should be able to click on terms tab' do
           ...
           expect(current_path).to eq(project_terms_path(project))
        end
      end
      ...
      describe '#reports' do
        it 'should be able to click on reports tab' do
           ...
           expect(current_path).to eq(reports_project_path(project))
        end
      end
    end
    ...
    context 'when is not my project' do
      ...
      it 'should not have reports tab' do
        expect(page).not_to have_selector("a[href='#{reports_project_path(project)}']")
      end

      it 'should not have edit link' do
        expect(page).not_to have_selector("a[href='#{edit_project_path(project)}']")
      end
    end
  end
end
